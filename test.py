...
STOCKNUMS=[8306,1607,9005,'^N225','VOOV','^DJI','JPY=X']   #取得する株価番号を入力します。
#STOCKNUMS=[1570]
...
EXECUTABLE_PATH="/usr/local/chromedriver/" #/chromedriver.exeのパスを指定する。
HOME_PATH="/mnt/chromeos/MyFiles/Downloads/" #株価データを保存する場所を指定する。
