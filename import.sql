LOAD DATA LOCAL INFILE 'C:/Users/josej/OneDrive/Documents/平成１５年.csv' INTO TABLE article5 FIELDS TERMINATED BY ',' ENCLOSED BY '"' ;
SELECT SUM(kingaku) FROM article3 WHERE day BETWEEN '2022-01-11' AND '2022-01-25';
SELECT noukamei, SUM(kingaku) FROM article3 WHERE day BETWEEN '2022-01-11' AND '2022-01-25' GROUP BY noukamei ORDER BY kumikan;
SELECT * FROM article3 WHERE day BETWEEN '2022-01-11' AND '2022-01-25' AND kumikan = '12';
